// Creates titan that is a type of enemy
import java.awt.*;
import java.io.*;
...
{	
	public Titan(Game game, int x, int y, Item item)
	{
		setMaxHp(300);
		setHp(getMaxHp());
		setDmg(50);
		...
		try
		{
			enemyStillImg = ImageIO.read(new File("images/titanStill.png"));
			enemyAttack1Img = ImageIO.read(new File("images/titanAttack1.png"));
			enemyAttack2Img = ImageIO.read(new File("images/titanAttack2.png"));
			enemyAttack3Img = ImageIO.read(new File("images/titanAttack3.png"));
		}
		catch(IOException e)
		{
